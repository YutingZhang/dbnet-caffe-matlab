...
class P2PSync : public GPUParams<Dtype>, public Solver<Dtype>::Callback,
    public Layer<Dtype>::LayerCallback, public InternalThread {
 public:
 ...
 protected:
  ...
  void on_batch(Dtype* data, const int size);
  int device() { return device_id; }
  ...
  BlockingQueue<Dtype*> batch_queue_;
  BlockingQueue<bool> finish_queue_;
