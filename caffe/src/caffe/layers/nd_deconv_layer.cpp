...
void ndDeconvolutionLayer<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void ndDeconvolutionLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void ndDeconvolutionLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(ndDeconvolutionLayer);
#endif

INSTANTIATE_CLASS(ndDeconvolutionLayer);
REGISTER_LAYER_CLASS(ndDeconvolution);
